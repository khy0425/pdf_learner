...
class ApiService {
  ...
  /// 기본 요약 API 엔드포인트
  static const String _summarizeEndpoint = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent';
  
  /// 기본 퀴즈 생성 API 엔드포인트
  static const String _quizEndpoint = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent';
